...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("icons/Wall.jpg"));
        Image i3 = ic.getImage().getScaledInstance(1400, 1000,Image.SCALE_DEFAULT);
        ...
        mb.add(Box.createRigidArea(new Dimension(500,100)));
